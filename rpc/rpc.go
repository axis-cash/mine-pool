...
func (r *RPCClient) GetWork() ([]string, error) {
	rpcResp, err := r.doPost(r.Url, "axis_getWork", []string{})
	if err != nil {
		return nil, err
	}
	var reply []string
...
func (r *RPCClient) GetBlockNumber() (int64, error) {
	rpcResp, err := r.doPost(r.Url, "axis_blockNumber", nil)
	if err != nil {
		return 0, err
	}
	var reply string
...
func (r *RPCClient) GetPendingBlock() (*GetBlockReplyPart, error) {
	rpcResp, err := r.doPost(r.Url, "axis_getBlockByNumber", []interface{}{"pending", false})
	if err != nil {
		return nil, err
	}
...
func (r *RPCClient) GetBlockByHeight(height int64) (*GetBlockReply, error) {
	...
	return r.getBlockBy("axis_getBlockByNumber", params)
}

func (r *RPCClient) GetBlockByHash(hash string) (*GetBlockReply, error) {
	params := []interface{}{hash, true}
	return r.getBlockBy("axis_getBlockByHash", params)
}
...
func (r *RPCClient) GetUncleByBlockNumberAndIndex(height int64, index int) (*GetBlockReply, error) {
	...
	return r.getBlockBy("axis_getUncleByBlockNumberAndIndex", params)
}
...
func (r *RPCClient) GetTxReceipt(hash string) (*TxReceipt, error) {
	rpcResp, err := r.doPost(r.Url, "axis_getTransactionReceipt", []string{hash})
	if err != nil {
		return nil, err
	}
	if rpcResp.Result != nil {
...
func (r *RPCClient) SubmitBlock(params []string) (bool, error) {
	rpcResp, err := r.doPost(r.Url, "axis_submitWork", params)
	if err != nil {
		return false, err
	}
	var reply bool
...
func (r *RPCClient) GetBalance(address string) (*big.Int, error) {
	rpcResp, err := r.doPost(r.Url, "axis_getBalance", []string{address, "latest"})
	if err != nil {
		return nil, err
	}
	var reply Balance
...
func (r *RPCClient) AddressUnlocked(from string) (bool, error) {
	rpcResp, err := r.doPost(r.Url, "axis_addressUnlocked", []string{from})
	var reply bool
	if err != nil {
		return false, err
	}
...
func (r *RPCClient) SendTransaction(from, to, gas, gasPrice, value string, autoGas bool) (string, error) {
	...
	rpcResp, err := r.doPost(r.Url, "axis_sendTransaction", []interface{}{params})
	var reply string
	if err != nil {
		return reply, err
	}
...
func (r *RPCClient) GetMaxAvailable(address string) (*big.Int, error) {
	...
	rpcResp, err := r.doPost(r.Url, "exchange_getMaxAvailable", []string{hexAddress, "AXIS"})
	if err != nil {
		return nil, err
	}
	var reply *Big
