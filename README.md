...
Mine pool is a open soruce Axis mining pool using PPLNS mode

### Features

**This pool is being further developed to provide an easy to use pool for AXIS miners. This software is functional however an optimised release of the pool is expected soon. Testing and bug submissions are welcome!**
...
Clone & compile:
    ...
    git clone https://github.com/axis-cash/go-axis
    git clone https://github.com/axis-cash/go-axis-import 
    git clone https://github.com/axis-cash/mine-pool
    cd  mine-pool
